...
export default function AdminMenuItemsPage() {
  ...
  useEffect(() => {
    Promise.all([menuItemApiRequest.list(undefined), categoryApiRequest.list()])
      .then(([itemRes, catRes]) => {
  ...
  // Thêm tạm vào console để debug
  console.log('items[0].categoryId:', items[0]?.categoryId);
  console.log('categories[0].id:', categories[0]?.id);
