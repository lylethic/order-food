...
export function TopBar({ title, subtitle, onLogout, right }: Props) {
  const { t } = useLang();
  return (
    <header className='fixed top-0 right-0 left-0 md:left-64 bg-white/80 backdrop-blur-md border-b border-slate-100 z-30 h-16 flex items-center px-8 justify-between shadow'>
      <div>
