...
#### Quản Lý Vị Trí Nhà Hàng

![Admin Location](public/admin_location.png)
_Quản lý vị trí của nhà hàng (Admin)_
...
- ✅ Cấu hình tọa độ GPS nhà hàng và bán kính cho phép đặt món
- ✅ Bật/tắt kiểm tra vị trí đặt món realtime của khách hàng
...
✅ **GPS Geofencing** - Giới hạn phạm vi đặt món dựa trên tọa độ GPS và bán kính có thể cấu hình linh động, hỗ trợ bật/tắt realtime từ Dashboard của Admin.
